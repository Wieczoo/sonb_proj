...
from .views import (crc_view, test_crc_page, test_node_page,
                    test_master_page, simulate_transmission_view,
                    test_simulation_page,create_node, get_all_nodes,
                    ensure_ten_online_nodes, shutdown_master, shutdown_node,
                    toggle_simulate_failure, shutdown_source_server)
...
urlpatterns = [
    ...
    path('simulate/', simulate_transmission_view, name='simulate_transmission_view'),
    ...
    path('toggle-simulate-failure/', toggle_simulate_failure, name='toggle_simulate_failure'),
    path('shutdown-source-server/', shutdown_source_server, name='shutdown_source_server'),
]
